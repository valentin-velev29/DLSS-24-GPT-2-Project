...
* [gpt-2_synthetic_reviews_sample.csv](): ...
* [gpt-2_synthetic_reviews_tested_prompts.csv](): ...
* [llama-3_synthetic_reviews.csv](): ...
* [llama-3_synthetic_reviews_sample.csv](): ...
...
* [preprocessing.ipynb](): Notebook for data preprocessing including:
  * Data cleaning
  * ...
  * ...
* [preliminary_data_analysis.ipynb](): Notbook for preliminary data analysis including:
...
* [llama-3_review_generation.ipynb](): Notebook for generating synthetic product reviews using LLaMA 3 8B and calculating perplexity. Note that the initialization of LLaMA 3 8B in Kaggle with a P100 GPU takes roughly 50 minutes.
